const products = [
  {
    ...
    badge: null,
    description: 'Классическая футболка из дышащей технической ткани. Плоские швы не натирают во время тренировок. Идеальна для зала, пробежек и активного отдыха.',
  ...
  },
  {
    ...
    badge: 'Новинка',
    badgeNew: true,
    description: 'Спортивный топ с бесшовной конструкцией и поддерживающим кроем. Идеален для йоги, пилатеса и занятий в зале. Мягкая ткань приятна на коже.',
  ...
  },
  {
    ...
    badge: null,
    description: 'Компрессионный лонгслив с анатомическим кроем. Повторяет форму тела, снижает вибрацию мышц. Подходит для занятий на улице и в зале в прохладную погоду.',
  ...
  },
  {
    ...
    badge: null,
    description: 'Тёплое флисовое худи для разминки и восстановления. Кенгуру-карман, регулируемый капюшон, удлинённый крой. Фирменная вышивка 7K на груди.',
  ...
  document.getElementById('modalContent').innerHTML = `
    <div class="modal__gallery">
      <img class="modal__main-img" id="modalMainImg"
           ...
           onclick="openLightbox(${0})" title="Нажмите для увеличения">
      ${p.images.length > 1 ? `
